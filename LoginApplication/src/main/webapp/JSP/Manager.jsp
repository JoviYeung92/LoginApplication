...
<center><h2><fmt:bundle basename="I18N/page">
	<fmt:message key = "managerlabel1.msg"></fmt:message>
	</fmt:bundle></h2></center>

<fmt:bundle basename="I18N/page">
	<fmt:message key = "managerlabel2.msg"></fmt:message>
...
<div style="text-align: center"><a href="JSP/ManagerOnlyPage.jsp" style="color: red;">
	<fmt:bundle basename="I18N/page">
	<fmt:message key = "managerlabel4.msg"></fmt:message>
	</fmt:bundle></a>
</div> 
